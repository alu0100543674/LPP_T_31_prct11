	    ...
	    describe Test::Examen do	  
	  		...
	  		context " #Expectativas para Examen y Interfaz" do
				...
				it " #Debe tener un array de preguntas" do 
		   			...
		   			expect(@interfaz1.hacer_examen(respuestas_usuario)).to eq(true)
		   			expect(@interfaz1.contador_acertadas.is_a?Integer).to eq (true)
		   			expect(@interfaz1.cont_erroneas.is_a?Integer).to eq (true)
	        	end
	        
				it " #Debe tener un array de preguntas. Todas mal" do
		    		respuestas_usuario = ["1","2","3","4","5"]
                	expect(@interfaz1.hacer_examen(respuestas_usuario)).to eq(false)
				end
